    ...
    return (
        <div >
            ...
            { 
              ...
              searchApp.length > 0 ? 
              <div className='grid py-15 lg:grid-cols-4 gap-10 mt-10 px-20 md:grid-cols-3 grid-cols-1'>  {(searchApp.map(appdata=> <Allcard key={appdata.id} appdata={appdata}></Allcard>) )} </div> :
             ( <h1 className=' text-center mt-50  mx-auto font-bold text-5xl'>Not found this app</h1>)
                     }
